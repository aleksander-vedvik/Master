...
func (n *Node) Read(ctx context.Context, in *ReadRequest) (resp *State, err error) {
	cd := gorums.CallData{
		Message: in,
		Method:  "gorumsexample.Storage.Read",
	}
...
func (n *Node) Write(ctx context.Context, in *State) (resp *WriteResponse, err error) {
	cd := gorums.CallData{
		Message: in,
		Method:  "gorumsexample.Storage.Write",
	}
...
func RegisterStorageServer(srv *gorums.Server, impl Storage) {
	srv.RegisterHandler("gorumsexample.Storage.Read", func(ctx gorums.ServerCtx, in *gorums.Message, finished chan<- *gorums.Message) {
		req := in.Message.(*ReadRequest)
		defer ctx.Release()
		resp, err := impl.Read(ctx, req)
		gorums.SendMessage(ctx, finished, gorums.WrapMessage(in.Metadata, resp, err))
	})
	srv.RegisterHandler("gorumsexample.Storage.Write", func(ctx gorums.ServerCtx, in *gorums.Message, finished chan<- *gorums.Message) {
