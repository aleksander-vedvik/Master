...
func RegisterMultiPaxosServer(srv *Server, impl MultiPaxos) {
	srv.RegisterHandler("proto.MultiPaxos.Write", func(ctx gorums.ServerCtx, in *gorums.Message, finished chan<- *gorums.Message) {
	...
	srv.RegisterHandler("proto.MultiPaxos.Accept", func(ctx gorums.ServerCtx, in *gorums.Message, _ chan<- *gorums.Message) {
		req := in.Message.(*AcceptMsg)
		defer ctx.Release()
		impl.Accept(ctx, req)
	})
	srv.RegisterHandler("proto.MultiPaxos.Learn", func(ctx gorums.ServerCtx, in *gorums.Message, _ chan<- *gorums.Message) {
