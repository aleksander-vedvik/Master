...
import (
	...
	pbftClient "github.com/aleksander-vedvik/benchmark/pbft.plain/client"
	pbftServer "github.com/aleksander-vedvik/benchmark/pbft.plain/server"
)
...
func (b *PbftSBenchmark) Init(opts RunOptions) {
	...
	fmt.Println("initializing the benchmark... (this takes about 10 seconds)")
